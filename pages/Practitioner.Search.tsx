...
export default function Home() {
  ...
  useEffect(() => {
    async function fetchData() {
      // @ts-ignore
      const appointments = await fetch(`https://fhir.epic.com/interconnect-fhir-oauth/api/FHIR/R4/Practitioner?given=Nurse&family=Care Manager`, {
        headers: {
  ...
  return (
    <Page>
      <section className="flex flex-col gap-6">
        <Text variant="h1">Practitioner.Search</Text>
      </section>
